            ...
            <div class="login-form">
                <div class="login-box">
                    ...
                    <div class="msg-wrap">
                        ...
                        <div
                                <c:if test="${empty error }">style="display: none;"</c:if> class="msg-error">
                            <b></b>${error }
                        </div>
                    </div>
                    <div class="mc">
