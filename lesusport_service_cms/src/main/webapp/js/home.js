...
function setArea() {
    var t, e = $("#shortcut-2013"), i = readCookie("areaId") || 1, a = {
            list: [{text: "\u5317\u4eac", val: 1}, {text: "\u4e0a\u6d77", val: 2}, {
                text: "\u5929\u6d25",
                val: 3
            }, {text: "\u91cd\u5e86", val: 4}, {text: "\u6cb3\u5317", val: 5}, {
                text: "\u5c71\u897f",
                val: 6
            }, {text: "\u6cb3\u5357", val: 7}, {text: "\u8fbd\u5b81", val: 8}, {
                text: "\u5409\u6797",
                val: 9
            }, {text: "\u9ed1\u9f99\u6c5f", val: 10}, {text: "\u5185\u8499\u53e4", val: 11}, {
                text: "\u6c5f\u82cf",
                val: 12
            }, {text: "\u5c71\u4e1c", val: 13}, {text: "\u5b89\u5fbd", val: 14}, {
                text: "\u6d59\u6c5f",
                val: 15
            }, {text: "\u798f\u5efa", val: 16}, {text: "\u6e56\u5317", val: 17}, {
                text: "\u6e56\u5357",
                val: 18
            }, {text: "\u5e7f\u4e1c", val: 19}, {text: "\u5e7f\u897f", val: 20}, {
                text: "\u6c5f\u897f",
                val: 21
            }, {text: "\u56db\u5ddd", val: 22}, {text: "\u6d77\u5357", val: 23}, {
                text: "\u8d35\u5dde",
                val: 24
            }, {text: "\u4e91\u5357", val: 25}, {text: "\u897f\u85cf", val: 26}, {
                text: "\u9655\u897f",
                val: 27
            }, {text: "\u7518\u8083", val: 28}, {text: "\u9752\u6d77", val: 29}, {
                text: "\u5b81\u590f",
                val: 30
            }, {text: "\u65b0\u7586", val: 31}, {text: "\u53f0\u6e7e", val: 32}, {
                text: "\u9999\u6e2f",
                val: 42
            }, {text: "\u6fb3\u95e8", val: 43}, {text: "\u9493\u9c7c\u5c9b", val: 84}, {
                link: !0,
                text: "\u6d77\u5916",
    ...
    a.def = {
        text: n,
        val: i
    }, e.find("ul").eq(0).after(s.process(a)), t = $("#home-area"), t.Jdropdown({event: "click"}), t.find(".dd ul a[data-id]").click(function () {
...
function hotSaleMod(t) {
    (function () {
        var e = function (t) {
                var e = document, i = e.getElementsByTagName("head"), a = e.createElement("style"),
                ...
                if (null !== i && (a = readCookie("ipLoc-djd") ? "&area=" + readCookie("ipLoc-djd").replace(/-/g, "_") : "&area=1"), void 0 !== t) {
                    ...
                    $.ajax({
                        url: n, dataType: "jsonp", success: function (t) {
                            if (!t && !t.length)
                                return !1;
        ...
        $.ajax({
            url: "http://x.jd.com/ShowInterface",
            data: {ad_type: 7, spread_type: 1, ad_ids: "269:" + n, template: 0, callback: "?"},
            scriptCharset: "utf-8",
            dataType: "jsonp",
            success: function (e) {
                if (e && e["269"] && e["269"].length == n) {
                    var a = e["269"],
                        s = '<div class="w w1" data-fid="8" id="hotSale" clstag="homepage|keycount|home2013|41a">                        <div class="m m1 catalogue" data-lazyload="1">                            <div class="mt ld">                                <div class="floor"><b class="fixpng b b1"></b><b class="fixpng b b2"></b><b class="b b3">9F</b><b class="fixpng b4"></b></div>                                <h2>\u70ed\u5356\u5546\u54c1</h2>                            </div>                         </div>                          <div class="hotSaleList">                                    <ul>',
                        o = "", r = " </ul>                    </div>", l = [];
                    for (var d in a)
                        l.push(a[d].sku_id);
                    i(l, function (e) {
                        for (var i in a) {
                            var n = a[i].sku_id, l = a[i].click_url, d = a[i].exposal_url, c = a[i].ad_title,
                                h = pageConfig.FN_GetImageDomain(n) + "pop/s150x150_" + a[i].image_url;
                        ...
                        $("#floors-list").append(s + o + r), $("#hotSale").find("img").Jlazyload({
                            type: "image",
                            threshold: 200,
                            placeholderClass: "err-product"
                        }), $("#hotSale .catalogue").Jlazyload({
                            type: "module",
    ...
    e.prototype = {
        init: function () {
            ...
            var e = t(document).scrollTop(), i = this.opts.start || this.$o.offset().top,
                a = this.opts.end || i + this.$o.outerHeight(), n = t(window).height();
...
BackPanelNew.prototype = {
    init: function (t) {
        ...
        }), this.resizeMask = !0), i > (t - e) / 2 && (this.resized = !0)
    }, add: function (t) {
        var e = $.extend({
            cName: "backtop",
            text: "<s></s>\u9876\u90e8",
        ...
        return;
        var e = this,
            i = '<div class="{if newTag}bp-item-new{/if} bp-item bp-item-${cName}" data-top="${scrollTo}">    <a href="${href}" class="${cName}" target="${target}">${text}</a><s></s></div>',
            a = $(i.process(t));
...
var Floors = {
    cacheData: null, data: function (t) {
        return "default" === t ? {
            sort: [0, 1, 2, 3, 4, 5, 6, 7],
            defaultFloors: [{id: 0}, {id: 1}, {id: 2}, {id: 3}, {id: 4}, {id: 5}, {id: 6}, {id: 7}]
        } : "extra" === t ? {
            list: [{def: !1, name: "\u5176\u5b83\u5206\u7c7b1", id: 9}, {
                def: !1,
                name: "\u5176\u5b83\u5206\u7c7b2",
                id: 10
            }, {def: !1, name: "\u5176\u5b83\u5206\u7c7b3", id: 11}, {
                def: !1,
                name: "\u5176\u5b83\u5206\u7c7b4",
                id: 12
            }, {def: !1, name: "\u5176\u5b83\u5206\u7c7b5", id: 13}, {
                def: !1,
                name: "\u5176\u5b83\u5206\u7c7b6",
                id: 14
            }]
        ...
        var e = this;
        $.ajax({
            url: "http://ai.jd.com/", dataType: "jsonp", success: function (i) {
...
(function () {
    ...
    $("#virtuals").Jtab({type: "dynamic", index: t, source: "data-url", delay: 200}, function (t, e, i) {
        ...
        $("#virtuals").find(".tab-arrow").animate({
            left: 0 == i ? 0 : i * a + 2,
            width: 0 == i ? a + 2 : a
        }, 500, "easeInOutQuint"), t && (1210 > screen.width && (t += "?990"), e.html('<iframe scrolling="no" height="139px" frameborder="0" width="100%" src="' + t + '"></iframe>'), "undefined" != typeof geminiVersionProxy && geminiVersionProxy.api !== void 0 && geminiVersionProxy.api.addListenerForIframe("1401093361039", e.find("iframe")[0]))
        ...
        return pageConfig.TIMER_Clothing = setTimeout(function () {
            t.animate({width: screen.width >= 1200 ? "190px" : "188px"}, {
                duration: 500,
                easing: "easeOutQuart"
            }).siblings().animate({width: screen.width >= 1200 ? "150px" : "148px"}, {duration: 500})
        }, 200), !1
    }).mouseout(function () {
    ...
    function e(t, e) {
        pageConfig.backTopFloor.add({
            text: Floors.getFloorName(e[t]),
            cName: "floor-links floor-fore" + e[t],
            href: "#none",
            dataSet: e[t],
            fn: function () {
    ...
    new BackPanelNew({id: "backpanel0708", start: 10}).init({
        text: "\u8fd4\u56de\u9876\u90e8", fn: function () {
        ...
        id: "backpanel-floor", start: 10, fadeIn: 500, onShow: function (i) {
        ...
        e && (pageConfig.backTopFloor.add({
            cName: "home-setting", text: "\u6211\u8981\u8bbe\u7f6e", href: "#none", dir: "bottom", fn: function () {
        ...
        var i = $("#virtuals-2014"), a = i.find(".close"), n = i.find(".mt ul.fore1 li"),
            s = i.find(".mc .virtuals-iframes"), o = null;
    ...
    t.fn.imgScroll = function (e, i) {
        ...
        return this.each(function () {
            function e(t) {
                m >= w + y && !k ? ($.addClass(j), b.removeClass(S)) : k || b.addClass(S), "left" !== p.eq(0).css("float") && p.css("float", "left"), g = n.width || p.eq(0).outerWidth(), v = n.height || p.eq(0).outerHeight(), f.css({
                    ...
                    top: 0,
                    left: 0
                }), "function" == typeof i && i.apply(f, [x, C, p.slice(x * w, x * w + y), p.slice(x * w + y - w, x * w + y)])
            }
            ...
            var h, f = t(this), u = f.find("ul").eq(0), p = u.children("li"), m = p.length, g = null, v = null,
                b = "string" == typeof n.next ? t(n.next) : n.next, $ = "string" == typeof n.prev ? t(n.prev) : n.prev,
                x = 0, w = n.step, y = n.visible, C = Math.ceil((m - y) / w) + 1, k = n.loop, _ = n.direction,
                I = n.evtType, A = n.disableClass, j = n.disableClassPerfix ? "prev-" + A : A,
                S = n.disableClassPerfix ? "next-" + A : A, T = n.navItems, M = n.navItmesWrapClass,
                N = t("." + M).length > 0, F = n.navItemActivedClass, P = n.status, L = n.statusWrapSelector,
                E = t(L).length > 0, O = !1, z = !0, J = 0 === (m - y) % w,
                B = n.template || '<ul>{for slide in list}<li><a href="${slide.href}" target="_blank"><img src="${slide.src}" alt="${slide.alt}" /></a></li>{/for}</ul>';
            if (n.data.length > 0) {
                if (!n.width || !n.height)
                    return !1;
                s(n.data)
