...
*/
function login() {
    return location.href = "/user/controller.html";
}
...
function clearCompare() {
    $("#comProlist").empty(), $("#compare").hide(), createCookie("compare", ""), proIDs = []
}
...
function sBuilder() {
    this.strings = [], this.length = 0, this.append = function (a) {
...
var initScrollY = 0, proIDs = [], pannel = {};
pannel.gotop = {
