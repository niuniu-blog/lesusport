...
function CombineShare(t) {
    this.$el = t.$el, this.imgs = "string" == typeof t.imgs ? [t.imgs] : t.imgs, this.onbeforeOpen = t.onbeforeOpen || function () {
        ...
        T2: {
            name: "sina",
            text: "\u65b0\u6d6a\u5fae\u535a",
            url: "http://share.jd.com/sina/controller.action"
        },
        T3: {name: "qqWeibo", text: "\u817e\u8baf\u5fae\u535a", url: "http://share.jd.com/qqweibo/controller.action"},
        T4: {name: "renren", text: "\u4eba\u4eba\u7f51", url: "http://share.jd.com/renren/controller.action"},
        T5: {name: "kaixin", text: "\u5f00\u5fc3\u7f51", url: "http://share.jd.com/kaixin001/controller.action"},
        T6: {name: "douban", text: "\u8c46\u74e3\u7f51", url: "http://share.jd.com/douban/controller.action"}
    }, this.init()
}
...
}), $("#controller").livequery("click", function () {
    $.login()
});
var Refresh = {
    init: function () {
