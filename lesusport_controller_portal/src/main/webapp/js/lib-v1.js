...
!function () {
    ...
    a = $.extend({
        ...
        loginMethod: "Login",
        loginUrl: "https://passport." + pageConfig.FN_getDomain() + "/new/controller.aspx",
...
var jdModelCallCenter = {
    settings: {clstag1: 0, clstag2: 0}, tbClose: function () {
        ...
        return c ? (location.href = "https://passport." + pageConfig.FN_getDomain() + "/new/controller.aspx?ReturnUrl=" + escape(location.href), void 0) : (setTimeout(function () {
            $.jdThickBox({
                type: "iframe",
                title: "\u60a8\u5c1a\u672a\u767b\u5f55",
...
$.extend(jdModelCallCenter, {
    ...
    $.extend(jdModelCallCenter.settings, {
        clstag1: "controller|keycount|5|3", clstag2: "controller|keycount|5|4", id: b, fn: function () {
...
var category = {
    ...
    DATA_Cookie: "aview",
    TPL_UnRegist: '<div class="prompt">            <span class="fl">\u60a8\u597d\uff0c\u8bf7<a href="javascript:controller()" clstag="homepage|keycount|home2013|04a">\u767b\u5f55</a></span>            <span class="fr"></span>        </div>',
