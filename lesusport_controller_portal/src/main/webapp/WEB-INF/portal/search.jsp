    ...
    <script type="text/javascript">
        ...
        function fqPrice(price) {
            if (brand == null || brand == "") {
                ...
                window.location.href = "/product/search?keyword="+${keyword}+
                "&brandId=" + brand + "&price=" + price;
            }
        }

        function addTab(o) {
            if ($(o).html().indexOf("价格") != -1) {
                //点击了价格
                window.location.href = "/product/search?keyword="+${keyword}+
                "&brandId=" + brand;
            } else {
                ...
                <c:if test="${fn:length(map) != 0 }">
                    <div class="sl-b-selected J_brandSelected">
                        ...
                        <c:forEach items="${map }" var="m">
                            <a title="${m.value }" href="javascript:" class="crumb-select-item" onclick="addTab(this)">
                                ...
                                <c:forEach items="${brands }" var="brand">
                                    <li id="brand-38118" data-initial="j" style="display:block;">
                                        <a href="javascript:" onclick="fqBrand('${brand.id }')"
                                           title="${brand.name }"><i></i>${brand.name }
                                        </a>
                                    </li>
                                </c:forEach>
                            </ul>
                        ...
                        <div class="ml-wrap">
                            <div id="J_filter" class="filter">
                                <div class="f-line top">
                                    <div class="f-sort"><a href="javascript:" class="curr">综合排序<i></i></a><a
                                            href="javascript:" class="">销量<i></i></a><a href="javascript:"
                                                                                        class="">价格<i></i></a><a
                                            href="javascript:" class="">评论数<i></i></a><a href="javascript:"
                                                                                         class="">新品<i></i></a>
                                    </div>
                                    <div class="f-search">
                                    ...
                                    <div id="J_topPage" class="f-pager"><span
                                            ...
                                            class="fp-prev disabled" href="javascript:">&lt;</a><a class="fp-next"
                                                                                                   onclick="SEARCH.page(3)"
                                                                                                   href="javascript:"
                                ...
                                <div class="f-line">
                                    ...
                                    <div id="J_feature" class="f-feature">
                                        <ul>
                                            ...
                                            <li><a data-field="prom_type" data-val="0" class="" href="javascript:"
                                                   onclick="searchlog(1,0,0,38)"><i></i>促销商品</a></li>
                                        </ul>
                                    </div>
                                    <div id="J_viewType" class="f-type" data-ref="1">
                                        <a class="ft-item shop" href="javascript:" data-value="3"
                                           onclick="searchlog(1,0,0,28)"><i class="i-shop"></i>店铺</a>
                                        <a class="ft-item grid selected" href="javascript:" data-value="2"
                                           onclick="searchlog(1,0,0,45)"><i class="i-grid"></i>商品</a>
                                    </div>
                                    <span class="clr"></span>
                                </div>
                            </div>
                                    ...
                                    <c:forEach items="${pagination.list }" var="product">
                                        <li data-sku="1711416562" class="gl-item">
                                            <div class="gl-i-wrap">
                                                <div class="p-img">
                                                    <a href="javascript:"
                                                       onclick="window.open('/product/detail/${product.id}')"
                                                       style="position: relative;">
                                                        ...
                                                        <div id="gwd_float_curve_trigger"
                                                            ...
                                                            <div class="gwd_float_curve_wrapper">
                                                                ...
                                                                <div class="gwd_float_curve_overlay">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <div class="p-name p-name-type-2">
                                                    <a target="_blank" title="满129立减10,199减20优惠券,支持货到付款"
                                                       href="javascript:"
                                                       onclick="window.open('http://localhost:8086/html/product/'+${product.id}+'.html')">
                                                        <em>${product.name }</em>
                                                    </a>
                                                </div>
                                                <div class="p-commit">
                                                    <strong>已有<a id="J_comment_1711416562" target="_blank"
                                                                 href="javascript:" onclick="">133</a>人评价</strong>
                                                </div>
                                                <div class="p-operate">
                                                    <a class="p-o-btn contrast J_contrast" data-sku="1711416562"
                                                       href="javascript:"><i></i>对比</a>
                                                    <a class="p-o-btn focus J_focus" data-sku="1711416562"
                                                       href="javascript:"><i></i>关注</a>
                                                    <a class="p-o-btn addcart" data-stock-val="1"
                                                       data-disable-notice="0" data-presale="0" href="javascript:"
                                        ...
                                        <li>
                                            <div class="p-img">
                                                <a href="javascript:"
                                                   ...
                                                   style="position: relative;">
                                                    <img width="160" height="160" data-img="1" src="/images/ad3.jpg"
                                                         class="err-product">
                                                    <div id="gwd_float_curve_trigger"
                                                         class="gwd_float_curve_trigger gwd_float_curve_up"
                                        ...
                                        <li>
                                            <div class="p-img">
                                                <a href="javascript:"
                                                   title="依琦莲新款瑜伽服套装 宽松大码女士瑜珈舞蹈服 健身服跳操服 8505长袖黑+红花裤子 L"
                                                   style="position: relative;">
                                                    <img width="160" height="160" data-img="1" src="/images/ad2.jpg"
                                                         class="err-product">
                                                    <div id="gwd_float_curve_trigger"
                                                         class="gwd_float_curve_trigger gwd_float_curve_up"
                                                         style="left: 40px; top: 49px;">
                                        ...
                                        <li>
                                            <div class="p-img">
                                                <a href="javascript:"
                                                   title="依琦莲新款瑜伽服套装 宽松大码女士瑜珈舞蹈服 健身服跳操服 8505长袖黑+红花裤子 L"
                                                   style="position: relative;">
                                                    <img width="160" height="160" data-img="1" src="/images/ad4.jpg"
                                                         class="err-product">
                                                    <div id="gwd_float_curve_trigger"
                                                         class="gwd_float_curve_trigger gwd_float_curve_up"
                                                         style="left: 40px; top: 49px;">
                                        ...
                                        <li>
                                            <div class="p-img">
                                                <a href="javascript:"
                                                   title="依琦莲新款瑜伽服套装 宽松大码女士瑜珈舞蹈服 健身服跳操服 8505长袖黑+红花裤子 L"
                                                   style="position: relative;">
                                                    <img width="160" height="160" data-img="1" src="/images/ad1.jpg"
                                                         class="err-product">
                                                    <div id="gwd_float_curve_trigger"
                                                         class="gwd_float_curve_trigger gwd_float_curve_up"
                                                         style="left: 40px; top: 49px;">
