                                                    ...
                                                    <li
                                                        ...
                                                        <div class="addr-detail">
															<span title="范冰冰 " class="addr-name" limit="6">范冰冰
																...
																XXXXXXXXX</span> <span
                                                                class="addr-tel">158***888888</span>
                                                        </div>
                                                            ...
                                                            <div class="p-img">
                                                                <a target="_blank"
                                                                   href="http://item.jd.com/1305606.html"><img
                                                                        src="/order_files/565d0624N54b49906_002.jpg"
                                                                        alt=""></a>
                                                            </div>
                                                            <div class="goods-msg">
                                                    ...
                                                    <div class="mode-tab-nav">
                                                        <ul>
                                                            ...
                                                            <li class="mode-tab-item" id="pick_shipment_item"><span
                                                                    class="m-txt">上门自提<span class="ftx01">(荐)</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                        ...
                                                        <ul class="mode-list">
                                                            <li>
                                                                <div class="fore1" id="payment_name_div">
                                                                    <span class="ftx-03">付款方式：</span> <input
                                                                        type="radio"
                                                    ...
                                                    <div class="mode-tab-con hide">
                                                        <div class="mode-promise">
															<span id="promise-ico"><a
                                                                    ...
                                                                    class="pop_FreightInsurance"
                                                                    title=""> </a></span>
                                                            <div class="promise-txt yfx_div_remark" id="137701">
                                                                为您购买了运费险，最高赔付20.00元/单
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div id="remarkId" style="margin-bottom: 7px">
                                <div class="form remark-cont">
                                    <input name="note" maxlength="45" size="15" class="itxt itxt01"
                                           ...
                                           type="text"><span
                                        class="ftx-03 ml10">&nbsp;&nbsp;提示：请勿填写有关支付、收货、发票方面的信息</span>
                                </div>
                            </div>
                        </div>
                        <div class="hr"></div>
                        ...
                        <div class="order-coupon">
                            ...
                            <div class="item" id="orderCouponItem">
                                <div class="toggle-title">
                                    <a class="toggler" href="#none"
                                       onclick="query_coupons()"><b></b>使用优惠券（京券/东券/免运费券）</a>
                                </div>
                ...
                <div class="statistic fr">
                    ...
                    <div class="list">
                        <span><i class="freight-icon"></i>运费：</span> <em class="price"
                                                                         id="freightPriceId"><font color="#FF6600">
                        ￥18.00</font></em>
                    </div>
