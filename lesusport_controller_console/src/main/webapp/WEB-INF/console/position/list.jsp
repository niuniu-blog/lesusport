    ...
    <table width="100%" cellspacing="1" cellpadding="0" border="0" style="" class="pn-ltable">
        ...
        <c:forEach items="${list}" var="l">
            <tr onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'" bgcolor="#ffffff">
                ...
                <td align="center"><input style="width:40px; border:1px solid #7e9db9" value="${l.sort}" name="sort"
                                          type="text">
                </td>
                <td align="center">
                    是
                ...
                <td align="center"><a class="pn-opt" href="v_edit.do?id=1">修改</a> | <a
                        onclick="if(!confirm('您确定删除吗？')) {return false;}" class="pn-opt"
                        href="o_delete.do?ids=1&amp;root=">删除</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
